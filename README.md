...
## Results
FP32 had the fastest model loading times however FP16 & INT8 had better inference times and frames per second.  I was expecting FP16 to load the fastest due to it's models faster due to less accuracy in the model than FP32 and I also noticed that when loading the same model face-detection-adas-binary-0001 (FP32-INT) my loading times varied across the FP16, FP32 & INT8 program runs.   


## Stand Out Suggestions

These tests were performed on a CPU device, it would be interesting to run these models using a varitey of environments to validate performance of these models across variety of hardware.    
